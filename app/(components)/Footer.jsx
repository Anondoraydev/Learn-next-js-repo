...
const Footer = () => {
    return (
        <div className='bg-[#0166FF] pt-12 pb-10'>
            <footer className="footer text-base-content p-10 sm:mx-auto max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10">
                ...
                <nav>
                    <h6 className="footer-title text-[#FFFFFF]">Legal</h6>
            ...
            <hr className='w-full mx-auto border-t-2 border-[#FFFFFF]' />
            <p className='pt-10 text-center text-[#FFFFFF] text-sm md:text-base'>
